...
if(isset($_POST["submit"])) {
    ...
    mysqli_query($connect, "INSERT INTO comment VALUES ('','$post_id','$name','$comment','0','$date')");
    header("location:index.php?detail=$post_id&success-comment#success");
}

/* TAMPIL COMMENT */
$comment      = mysqli_query($connect, "SELECT * FROM comment WHERE post_id = '$detail_id' 
...
<article>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        ...
        </span> <?php echo $data ?> Komentar</h3>
      </div>
