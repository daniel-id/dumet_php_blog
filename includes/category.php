...
if (isset($_GET["page-category"])) {
  $current_page   = $_GET["page-category"];
    ...
    <nav class="text-center">
      <ul class="pagination">
        <?php if($current_page > 1) { ?>
          <li>
              <a href="index.php?page-category=<?php echo ($current_page - 1)."&category=".$category_id ?>" aria-label="Previous">
        ...
        <?php if($current_page < $total_page) { ?>
          <li>
            <a href="index.php?page-category=<?php echo ($current_page + 1)."&category=".$category_id ?>" aria-label="Next">
